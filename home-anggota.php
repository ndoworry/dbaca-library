...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1 class="text-light"><a href="home-anggota.php"><span>Dbaca</span></a></h1>
    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <h2>Selamat! Anda telah menjadi anggota Perpustakaan DBaca. Silahkan klik tombol di bawah ini untuk melihat buku yang tersedia.</h2>
          <div>
            <a href="semua.php" class="btn-get-started scrollto">Lihat Daftar Buku</a>
          </div>
        </div>
        <div class="col-lg-6 order-1 order-lg-2 hero-img">
          <img src="assets/img/user.svg" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
