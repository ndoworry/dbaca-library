    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <?php echo"<h1> Hallo admin ".$_SESSION['nama']."</h1>";?>
          <h2>Selamat datang di halaman Admin Perpustakaan DBaca</h2>
          <div>
            <a href="tambah_buku.php" class="btn-get-started scrollto">Tambah Buku</a>
          </div>
        </div>
        <div class="col-lg-6 order-1 order-lg-2 hero-img">
          <img src="assets/img/admin.svg" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
